...
<div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
    <div class="mb-6 flex flex-wrap items-center justify-between gap-4">
        ...
        <a href="{{ route('admin.tamu') }}" class="rounded-xl border border-primary/20 bg-primary/10 px-3 py-1.5 text-xs font-bold text-[#c79782] hover:bg-primary/20 transition-colors">
            Lihat Semua Tamu
        </a>
    </div>
